...
pmoVO.setFrom_id(request.getParameter("from_id"));
List<MemoVO> memoList = moLogic.getSendMemoList(pmoVO);
...
<table border="1" borderColor="blue" width="100%" height="100%">
 ...
 <table id="tb_smemoList" toolbar="#tbar_memoList" title="보낸쪽지함" class="easyui-datagrid" style="width:800px;height:400px" rownumbers="true">
<!-- 테이블 헤더 구성하기 -->
	<thead>
	<tr>
		<th field="no" align="center" width="80">번호</th>
		<th field="mem_name" align="center" width="150">받는사람 이름</th>
	    <th field="from_id" align="center" width="150">받는사람아이디</th>
