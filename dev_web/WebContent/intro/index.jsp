...
<%
	...
	else if("memo".equals(u_menu)){//너 쪽지관리 눌렀니?
%>
<%@ include file="memoIntro.jsp" %>
<%
	}
	else if("getReceiveMemoList".equals(u_menu)){//너 받은쪽지함 눌렀니?
%>
<jsp:include page="getReceiveMemoList.jsp" >
<jsp:param name="to_id" value="<%=sid %>"></jsp:param>
</jsp:include>

<%
	}
	else if("getSendMemoList".equals(u_menu)){//너 쪽지관리 눌렀니?
%>

<jsp:include page="getSendMemoList.jsp" >
<jsp:param name="from_id" value="<%=sid %>"></jsp:param>
</jsp:include>
<%
	}
%>
