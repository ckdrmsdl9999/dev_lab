...
public class ClientWait extends JPanel implements ActionListener {
	//선언부
		...
		JButton jbtn_whisper = new JButton("귓속말",new ImageIcon(path+"message.png"));
		JButton jbtn_change = new JButton("대화명변경",new ImageIcon(path+"change.png"));
		JButton jbtn_makeRoom = new JButton("방 만들기",new ImageIcon(path+"room.png"));
		JButton jbtn_roomIN = new JButton("방 참여하기",new ImageIcon(path+"roomin.png"));
		JButton jbtn_stateChange = new JButton("남긴말 설정",new ImageIcon(path+"chattt.png"));
		...
		public ClientWait(ChattingClient cc, String nickName){
			   ...
			   this.nickName=nickName;
				...
				jbtn_makeRoom.setBorderPainted(false);
				jbtn_makeRoom.setContentAreaFilled(false);
				jbtn_makeRoom.setBackground(Color.white);
				jbtn_makeRoom.addActionListener(this);
				
				jbtn_roomIN.setBorderPainted(false);
				jbtn_roomIN.setContentAreaFilled(false);
				jbtn_roomIN.setBackground(Color.white);
				jbtn_roomIN.addActionListener(this);
				
				jbtn_stateChange.setBorderPainted(false);
				jbtn_stateChange.setContentAreaFilled(false);
				jbtn_stateChange.setBackground(Color.white);
				...
				jp_first.setBackground(new Color(122,238,184)); //panel색상
				jp_first_south.setBackground(new Color(122,238,184));
...
//					nickName=afterName;
				...
				if(jt_room.getRowCount()>0){
					...
					try {
						System.out.println("방제목전송"+roomName);
						cc.cr.roomName=roomName;
