...
/******************************************************************
 * String
 * 1)원시타입과 같은 방법으로 초기화할 수 있다. String s = "야구게임"; 
 *  :기존에 같은 문자열을 갖는 String이 존재하면 새로 생성되지 않고
 *   기존에 문자열을 같이 참조 한다.
 ...
 *   
 * 생성자를 호출할 때 마다 타입은 같지만 새로운 객체가 만들지는 
 * 것이다.  
 ******************************************************************/
public class StringTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("야구게임".length());//4
		new String("야구게임");
