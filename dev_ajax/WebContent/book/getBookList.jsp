...
<script type="text/javascript">
	...
	function bookDetail(booknumber){
		
	
		
		if(booknumber!=null){
		
		var param2 = "ab_no="+booknumber;
...
<!-- North영역 시작 -->
<!-- 도서검색 바 시작 -->
<div data-options="region:'north',title:'도서검색',split:true" style="width:1000px;height:100px;">
	<div id="d_book">
