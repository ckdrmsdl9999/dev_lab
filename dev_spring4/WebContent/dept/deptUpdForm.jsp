...
<body>
<div id="pan_deptUpd" title="부서정보수정" buttons="#dlg_buttons" class="easyui-panel" style="width:500px">
<!-- 서버로 사용자가 입력한 정보를 전송합니다.(form전송으로 처리하기) -->
	<form id="f_deptUpd" style="margin:0;padding:20px 50px"> 	
 	...
 	<div style="margin-bottom:10px">
 	<input name="loc" value="<%=rMap.get("LOC") %>" class="easyui-textbox" label="지역 : " style="width:100%">
 	</div>
 <div id="dlg_buttons">
 	<center>
	<a href="#" class="easyui-linkbutton c1" iconCls="icon-ok" plain="true" onClick="updateAction()" style="width:90px">수정</a>
	<a href="#" class="easyui-linkbutton c1" iconCls="icon-cancel" plain="true" onClick="javascript:window.close()" style="width:90px">취소</a>
	</center>
</div>
 	</form>	
 </div>
